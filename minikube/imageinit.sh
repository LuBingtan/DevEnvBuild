...
sudo docker pull registry.cn-shanghai.aliyuncs.com/lubingtan-k8s/etcd-amd64:3.1.12
...
image_name2=k8s.gcr.io/etcd-amd64:3.1.12
...
sudo docker tag registry.cn-shanghai.aliyuncs.com/lubingtan-k8s/etcd-amd64:3.1.12 $image_name2
