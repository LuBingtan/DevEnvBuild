...
sudo docker pull registry.cn-shanghai.aliyuncs.com/lubingtan-k8s/kube-apiserver-amd64:v1.10.0
sudo docker pull registry.cn-shanghai.aliyuncs.com/lubingtan-k8s/kube-controller-manager-amd64:v1.10.0
sudo docker pull registry.cn-shanghai.aliyuncs.com/lubingtan-k8s/kube-proxy-amd64:v1.10.0
sudo docker pull registry.cn-shanghai.aliyuncs.com/lubingtan-k8s/kube-scheduler-amd64:v1.10.0
...
image_name8=k8s.gcr.io/kube-apiserver-amd64:v1.10.0
image_name9=k8s.gcr.io/kube-controller-manager-amd64:v1.10.0
image_name10=k8s.gcr.io/kube-proxy-amd64:v1.10.0
image_name11=k8s.gcr.io/kube-scheduler-amd64:v1.10.0
...
sudo docker tag registry.cn-shanghai.aliyuncs.com/lubingtan-k8s/kube-apiserver-amd64:v1.10.0 $image_name8
sudo docker tag registry.cn-shanghai.aliyuncs.com/lubingtan-k8s/kube-controller-manager-amd64:v1.10.0 $image_name9
sudo docker tag registry.cn-shanghai.aliyuncs.com/lubingtan-k8s/kube-proxy-amd64:v1.10.0 $image_name10
sudo docker tag registry.cn-shanghai.aliyuncs.com/lubingtan-k8s/kube-scheduler-amd64:v1.10.0 $image_name11
